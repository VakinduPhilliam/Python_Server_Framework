...
#
# You can also create a Document by calling a method on a “DOM Implementation” object. You can get this object either by calling the getDOMImplementation()
# function in the xml.dom package or the xml.dom.minidom module. Once you have a Document, you can add child nodes to it to populate the DOM:
...
# These properties are defined in the DOM specification. The main property of the document object is the documentElement property.
